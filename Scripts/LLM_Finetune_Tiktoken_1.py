...
class GPTLanguageModel(nn.Module):
    ...
    def forward(self, index, targets=None):
        ...
        B, T = index.shape
        #print("vocab_size, n_embd:", vocab_size, ",", n_embd)
        #print("block_size, n_embd:", block_size, ",", n_embd)
        #print("B, T: ", B, ",", T)
        print(index)
...
def estimate_loss():
    model.eval()
    batch_x, batch_y = get_batch(qa_tokenized)
